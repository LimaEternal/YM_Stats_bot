import requests
from stats_manager import day_before_yesterday_date
...
async def get_yesterday_music_stats(bot=None):
    ...
    # В API мы запрашиваем данные за текущий месяц, но получаем данные с задержкой (фактически за позавчера)
    ...
    payload = {
        ...
        "variables": {
            "input": {
                "period": {
                    "month": day_before_yesterday_date.month,
                    "year": day_before_yesterday_date.year,
                },
                "scale": "MONTH",
            }
        },
